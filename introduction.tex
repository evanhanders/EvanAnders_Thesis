...
However, inferring information about a star's structure from asteroseismic data is difficult due to the small number of measurable frequencies available.
...
%To a lesser extent, the same has also been asked of the Reynolds number, Re$\,= \angles{|\bm{u}|} L / \nu$, where $\bm{u}$ is the velocity.
...
These simulations visually resemble solar surface convection so convincingly that the raw data of e.g., \cite{rempel2014}'s simulations are being used directly as high-resolution observations of solar convection \cite[see e.g.,][and others]{vankooten&cranmer2017, shchukina&trujillo2019}.
...
Distributed dye and light have been used to model driving of convection by internal heating, as in the interior of stars.
