...
This stiffness can be avoided using approximations such as the anelastic approximation, in which sound waves are explicitly filtered out \cite{brown&all2010, featherstone&hindman2016}.
...
Some modern studies do just that \cite{featherstone&hindman2016}.
